...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 14 16:02:58 2026
...
async def scrape_walmart_page(session:httpx.AsyncClient, query:str="fruit drink mix", page=1):
...
async def main():
    ...
    output_file = export_dir / "walmart_fruit-drink-mix.json"
