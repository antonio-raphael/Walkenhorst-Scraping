...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 14 16:34:48 2026
...
async def scrape_walmart_page(session:httpx.AsyncClient, query:str="spread", page=1):
...
async def scrape_search(search_query:str, session:httpx.AsyncClient, max_scrape_pages:int=None) -> List[Dict]:
    ...
    max_page = math.ceil(total_items / 52)
...
async def main():
    ...
    output_file = export_dir / "walmart-spreads.json"
