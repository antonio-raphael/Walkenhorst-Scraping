...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 14 14:02:10 2026
...
async def scrape_walmart_page(session:httpx.AsyncClient, query:str="Nutrition Supplements", page=1):
...
async def main():
    ...
    output_file = export_dir / "walmart_Nutrition-Supplements.json"
    ...
    async with httpx.AsyncClient(
        ...
        results = await scrape_search(
            search_query="Nutrition Supplements",
            session=session,
            max_scrape_pages=25
        )
