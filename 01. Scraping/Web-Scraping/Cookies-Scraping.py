...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 14 13:24:58 2026
...
async def scrape_walmart_page(session:httpx.AsyncClient, query:str="cookies", page=1):
...
async def main():
    ...
    output_file = export_dir / "walmart_cookies.json"
