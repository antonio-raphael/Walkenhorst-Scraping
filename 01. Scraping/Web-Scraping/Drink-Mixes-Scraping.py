...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 14 15:38:08 2026
...
async def scrape_walmart_page(session:httpx.AsyncClient, query:str="Drink Mixes", page=1):
...
async def main():
    ...
    output_file = export_dir / "walmart_Drink-Mixes.json"
