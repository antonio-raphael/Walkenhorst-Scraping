...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 14 15:55:07 2026
...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 14 15:49:45 2026
...
async def scrape_walmart_page(session:httpx.AsyncClient, query:str="soft drinks 17.7oz", page=1):
...
async def main():
    ...
    output_file = export_dir / "walmart_soft-drinks-177oz.json"
    ...
    async with httpx.AsyncClient(
        ...
        results = await scrape_search(
            search_query="soft drinks 17.7oz",
            session=session,
            max_scrape_pages=25
        )
